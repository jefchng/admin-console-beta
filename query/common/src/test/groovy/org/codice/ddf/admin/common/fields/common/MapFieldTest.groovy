...
class MapFieldTest extends Specification {
    ...
    static ENTRIES = MapField.ENTRIES
    ...
    def 'Fail validation due to duplicate keys'() {
        setup:
        mapField = new DuplicatesAllowedMapField()
        mapField.put('key1', 'value1')
        mapField.put('key2', 'value2')
        mapField.put('key1', 'value3')
    ...
    class DuplicatesAllowedMapField extends MapField {

        @Override
        MapField put(String key, String value) {
